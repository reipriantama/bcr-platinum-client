...
const FormSignUp = () => {
  ...
  const handleInputNama = (e) => {
    setInputCustomer({ ...inputCustomer, nama: e.target.value });
  };
  ...
  const signUpProcess = async () => {
    try {
      ...
      if (
        ...
        error.message !== "Password kurang dari 6 karakter."
      ) {
  ...
  return (
    ...
    >
      ...
      <div
        className={`${style.flex_size_1} ${style.flex_position_1} d-flex flex-column gap-4 `}
      >
        ...
        <div>
          <form>
            <div className="mb-3">
              <label for="input-nama" className="form-label">
                Nama*
              </label>
              <input
                type="text"
