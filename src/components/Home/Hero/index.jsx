        ...
        <div className={`${style.modal}`}>
          <div className={`${style.modal_container}`}>
            <span className={`${style.popup}`}>
              Harap Sign In atau Registrasi terlebih dahulu.
            </span>
          </div>
        </div>
      )}
        ...
        <div className="container">
          <div className="row first" style={{ paddingTop: padTop }}>
            <div className="col-sm-6">
              <div className="row">
                <div className="first-tagline" style={{ display: displayText }}>
                  Sewa & Rental Mobil Terbaik di kawasan (Lokasimu)
                </div>
                <div
                  className="first-tagline-description"
